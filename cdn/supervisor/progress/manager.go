...
type Manager interface {
	...
	WatchSeedProgress(ctx context.Context, taskID string) (<-chan *SeedPiece, error)

	// PublishPiece publish piece seed
	PublishPiece(ctx context.Context, taskID string, piece *SeedPiece) error
	...
	GetPieces(taskID string) (records []*SeedPiece, err error)
...
//	seedTaskSubjects map[string]Subject
//}
//
...
//	pm.seedTaskSubjects[taskID] = &subject{}
...
//}
//
//func (pm *manager) WatchSeedProgress(ctx context.Context, taskID string) (<-chan *SeedPiece, error) {
//	span := trace.SpanFromContext(ctx)
...
//	//ch := make(chan *SeedPiece, pm.buffer)
...
//}
//
//func (pm *manager) PublishPiece(ctx context.Context, taskID string, record *SeedPiece) {
//	span := trace.SpanFromContext(ctx)
...
//}
//
//func (pm *manager) GetPieces(taskID string) (records []*SeedPiece, ok bool) {
...
//
//// addPieceMetaRecord
//func (pm *manager) addPieceMetaRecord(taskID string, record *SeedPiece) {
...
//func (pm *manager) getPieceMetaRecords(taskID string) (records []*SeedPiece, ok bool) {
